...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Fast</span>food corner.</a>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/hotn spicy wings.jpeg" alt="">
            </div>
            <div class="content">
               <h3>hot and spicy wings</h3>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/noodles1.jpeg" alt="">
            </div>
            <div class="content">
               <h3>Noodles</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Every dish that leaves our kitchen is crafted with  care, and an commitment to quality. We believe that the secret ingredient to extraordinary food lies in the love and attention that goes into its creation.  </p>
      ...
      <div class="box">
         ...
         <p>Experience fastfood corner's superfast delivery for food delivered fresh & on time.Introducing our lightning-fast delivery service! Say goodbye to waiting and hello to convenience. </p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Food tastes even better when shared with friends, as joy and laughter become the perfect seasoning. Gather your loved ones around the table and indulge in a feast that goes beyond sustenance.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
...
<section class="faq" id="faq">
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         We accept various payment methods, including credit/debit cards, mobile wallets, and online payment platforms. You can find a complete list of accepted payment methods during the checkout process.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
         We strive to deliver your order as quickly as possible. Delivery times typically range from 30 mins to 1 hours, depending on your location and the availability of our delivery partners.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            yes! you can order for hige parties
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
         We currently offer delivery to urban areas. However, we are continuously expanding our delivery network, so check back regularly to see if we've reached your area.
         </p>
      </div>
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>Can I schedule a delivery for a specific time?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         Yes, we offer the option to schedule deliveries for a specific time within our operating hours. During the checkout process, you can select a convenient delivery time slot based on availability.
         </p>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>azamalmassk458@gmail.com</p>
         <p>21kb1a05f2@nbkrist.org</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Mr. Shaik Almas Azam</span> | all rights reserved!
   </div>
